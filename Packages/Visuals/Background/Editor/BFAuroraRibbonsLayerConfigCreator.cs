...
namespace BFTools.Visuals.Background.Editor
{
    public static class BFAuroraRibbonsLayerConfigCreator
    {
        ...
        [MenuItem("Assets/Create/BFTools/Visuals/Background/Config/Layer/Aurora Ribbons Layer Config", priority = BFMenuPriority.Group.Visuals + BFMenuPriority.Module.Background)]
