...
namespace BFTools.Visuals.Background.Editor
{
    public static class BFTwinklingStarsLayerConfigCreator
    {
        ...
        [MenuItem("Assets/Create/BFTools/Visuals/Background/Config/Layer/Twinkling Stars Layer Config", priority = BFMenuPriority.Group.Visuals + BFMenuPriority.Module.Background)]
